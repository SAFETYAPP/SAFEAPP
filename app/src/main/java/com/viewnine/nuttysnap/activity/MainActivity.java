...
import com.viewnine.nuttysnap.youtube.ulti.ImageCache;
import com.viewnine.nuttysnap.youtube.ulti.ImageFetcher;
import com.viewnine.nuttysnap.youtube.ulti.Upload;
import com.viewnine.nuttysnap.youtube.ulti.Utils;
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                YouTube youtube = new YouTube.Builder(transport, jsonFactory,
                        credential).setApplicationName(com.viewnine.nuttysnap.youtube.Constants.APP_NAME)
                        .build();
                try {
        ...
        new AsyncTask<Void, Void, List<VideoData>>() {
            ...
            protected List<VideoData> doInBackground(Void... voids) {
                ...
                try {
                    ...
                    Utils.logAndShow(MainActivity.this, com.viewnine.nuttysnap.youtube.Constants.APP_NAME, e);
                }
                return null;
            }
...
//    }
    ...
    public void uploadVideo(View view) {
        ...
        mFileUri = Uri.fromFile(new File(videoPath));
        // if a video is picked or recorded.
        if (mFileUri != null) {
            Intent uploadIntent = new Intent(this, UploadService.class);
            uploadIntent.setData(mFileUri);
            uploadIntent.putExtra("VIDEO_PATH", "/storage/emulated/0/SafeApp/Videos/SafeApp_1433159009513.mp4");
